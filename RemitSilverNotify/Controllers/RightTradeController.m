...
- (void)setup
{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"TradeCell" bundle:nil] forCellReuseIdentifier:@"kTradeCell"];
    [self.tableView registerNib:[UINib nibWithNibName:@"NoDataCell" bundle:nil] forCellReuseIdentifier:@"kNoDataCell"];
}
...
{
    if (self.tradeArray.count > 0) {
        static NSString *identifier = @"kTradeCell";
        ...
        static NSString *identifier = @"kNoDataCell";
